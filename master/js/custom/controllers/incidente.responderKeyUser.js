App.controller('incidente.responderKeyUser', ['$scope','Auth','$http','$stateParams','FileUploader','ngDialog','$state', function($scope,Auth,$http,$stateParams,FileUploader,ngDialog,$state) {
...
$scope.guardar =  function(){
   $scope.paginaValida = !$scope.formResponderKeyUserIncidente.$error.required;
 console.log($scope.formResponderKeyUserIncidente.$error)
